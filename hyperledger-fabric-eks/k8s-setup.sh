...
kubectl create -f /Users/ayushverma/Desktop/stezy/k8s/fabric-external-chaincodes/pv/  -n hyperledger
...
kubectl cp /Users/ayushverma/Desktop/stezy/k8s/fabric-external-chaincodes/configtx.yaml fabric-tools:/fabric/config/  -n hyperledger
kubectl cp /Users/ayushverma/Desktop/stezy/k8s/fabric-external-chaincodes/crypto-config.yaml fabric-tools:/fabric/config/ -n hyperledger
